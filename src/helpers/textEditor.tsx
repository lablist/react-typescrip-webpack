...
import { BlockType, EntityType, InlineStyle, KeyCommand } from "./textEditorConfig";
import { HTMLtoState, stateToHTML } from "./textEditorConvert";
import LinkDecorator from "../components/textEditor/link";

export type EditorApi = {
  state: EditorState;
  setStateFromHTML: (html?: string) => void;
...
export const useEditor = (html?: string): EditorApi => {
  ...
  const setStateFromHTML = React.useCallback((newHtml) => {
    setState(EditorState.createWithContent(HTMLtoState(newHtml), decorator));
  }, [state]);
